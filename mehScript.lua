...
--===============--
    ...
    local supported_lang_table = {"en","en-us","hornyuwu","uwu","sex","fr"}
...
--===============--
    ...
    --===============--
        ...
        -- protections
            ...
            protectionm:action(Translate("Ultimate"),{},Translate("Active toutes les protections."),function()
...
--===============--
    ...
    PlayerMenu = function(pid)
        ...
        -- griefing
            ...
            local bounty = griefm:list(Translate("Bounty"), {}, "")
            local bounty_ammount = 10000
            bounty:toggle_loop(Translate("Auto Bounty"),{},"", function()
                menu.trigger_commands("bounty" .. player_name .. " " .. bounty_ammount)
                util.yield(12000)
            end)
